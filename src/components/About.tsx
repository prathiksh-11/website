    ...
    <div className="min-h-screen bg-[#f7f8fb]">
      ...
      <PageHero
        ...
        title={
          <>
            ...
            <br />
            <span className="italic text-[#e07a72]">We started to build stronger people.</span>
          </>
        }
      ...
      <section className="py-24 atmosphere">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold text-[#16181f] leading-tight mb-6">
            ...
            <br />
            It&apos;s about <span className="italic text-[#e07a72]">living better.</span>
          </h2>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="font-display text-3xl md:text-5xl font-bold text-[#16181f]">
              More than a <span className="italic text-[#e07a72]">gym.</span>
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-5">
            {beliefs.map((item) => (
              <div
                key={item.title}
                className="rounded-[1.75rem] border border-[rgba(22,24,31,0.06)] bg-white p-8 hover:border-[#e07a72]/25 hover:shadow-[0_20px_50px_rgba(22,24,31,0.08)] transition-all duration-400"
              >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold text-[#16181f] leading-tight mb-6">
            More than <span className="italic text-[#e07a72]">machines.</span>
          </h2>
      ...
      <section className="py-24 atmosphere">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold text-[#16181f] leading-tight mb-6">
            Welcomed. Supported. <span className="italic text-[#e07a72]">Inspired.</span>
          </h2>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold text-[#16181f] leading-tight mb-6">
            ...
            <span className="italic text-[#e07a72]">written yet.</span>
          </h2>
      ...
      <section className="py-24 atmosphere">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="font-display text-3xl md:text-5xl font-bold text-[#16181f] mb-5">
            Join the <span className="italic text-[#e07a72]">movement.</span>
          </h2>
